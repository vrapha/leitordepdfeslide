...
def build_prompt(question: str, alternatives: list[str], correct: str) -> str:
    ...
    prompt = (
        ...
        "Seu objetivo é escrever um comentário didático, técnico e objetivo sobre uma questão "
        "de múltipla escolha, com foco em aprendizado e revisão para alunos que estão estudando "
        "para a prova. Utilize nos comentários apenas fontes do ministério da saúde e das principais "
        "diretrizes nacionais e internacionais. Comente a questão abaixo seguindo exatamente esta estrutura: "
        "1. Dica de Prova (no topo): Traga uma frase curta e prática (aproximadamente 60 palavras), "
        "como um macete ou orientação objetiva, que ajude o aluno a lembrar como acertar questões semelhantes. "
        "Evite explicações longas aqui — a dica deve ser aplicada em segundos durante a prova. "
        "2. Resumo do Tema: Escreva um parágrafo contínuo com aproximadamente 250 palavras explicando "
        "os principais conceitos e raciocínio envolvidos na questão. Trate como uma mini-revisão do tema, "
        "trazendo os pontos-chave que todo candidato deve saber. Use uma linguagem técnica, mas acessível, "
        "objetiva e voltada para revisão. "
        "3. Comentário Alternativa por Alternativa: • Letra A: Diga se está correta ou incorreta. "
        "Se incorreta, explique com clareza por que está errada, apontando o erro conceitual ou o distrator típico. "
        "Use aproximadamente 30 palavras. • Letra B: (Repita o mesmo formato) • Letra C: (…) • Letra D: (…) • Letra E: (…) "
        "4. Resposta Correta: Finalize escrevendo apenas: Resposta correta: Letra X, com a letra correspondente. "
        "Outras diretrizes importantes: • Seja didático, mas direto. • Evite floreios ou explicações excessivamente teóricas. "
        "• Foque no que mais cai, nos padrões das bancas e nos erros que os alunos mais cometem. "
        "• O texto deve ensinar e revisar ao mesmo tempo.\n\n"
        "QUESTÃO:\n" + question + "\n\n"
        "ALTERNATIVAS:\n" + alts_str + "\n\n"
    )
