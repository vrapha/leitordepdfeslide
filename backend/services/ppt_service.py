...
def build_prompt(question: str, alternatives: list[str], correct: str) -> str:
    ...
    prompt = (
        ...
        "1. Especialidade e Assunto (no topo): Escreva no início os campos 'Especialidade:' e 'Assunto:', "
        "deixando-os em branco pois serão preenchidos manualmente.\n"
        "2. Dica de Prova (logo abaixo): Traga uma frase curta e prática (aproximadamente 60 palavras), "
        ...
        "3. Resumo do Tema: Escreva um parágrafo contínuo com aproximadamente 250 palavras explicando "
        "os principais conceitos e raciocínio envolvidos na questão. Trate como uma mini-revisão do tema, "
        "trazendo os pontos-chave que todo candidato deve saber. "
        "4. Comentário Alternativa por Alternativa: • Letra A: Diga se está correta ou incorreta. "
        "Se incorreta, explique com clareza por que está errada. Use aproximadamente 30 palavras. "
        "• Letra B: (Repita o mesmo formato) • Letra C: (…) • Letra D: (…) • Letra E: (…) "
        "5. Resposta Correta: Finalize escrevendo apenas: Resposta correta: Letra X, com a letra correspondente.\n\n"
        "QUESTÃO:\n" + question + "\n\n"
        "ALTERNATIVAS:\n" + alts_str + "\n\n"
    )
