...
def build_prompt(question: str, alternatives: list[str], correct: str) -> str:
    ...
    prompt = (
        ...
        "IMPORTANTE: Responda em texto puro, sem usar markdown. "
        ...
        "Especialidade:\n"
        "[identifique a especialidade médica da questão, ex: Cardiologia, Clínica Médica]\n\n"
        "Assunto:\n"
        "[identifique o assunto específico, ex: Infarto Agudo do Miocárdio com Supra de ST]\n\n"
        "Dica de Prova:\n"
        ...
        "A dica deve ser aplicada em segundos durante a prova.]\n\n"
        "Resumo do Tema:\n"
        "[parágrafo contínuo com aproximadamente 250 palavras explicando os principais conceitos e raciocínio "
        "envolvidos. Mini-revisão do tema com os pontos-chave que todo candidato deve saber. "
        "Linguagem técnica, acessível, objetiva e voltada para revisão.]\n\n"
        "Comentário Alternativa por Alternativa:\n"
        "Letra A: [correto ou incorreto + motivo em ~30 palavras]\n"
        "Letra B: [correto ou incorreto + motivo em ~30 palavras]\n"
        "Letra C: [correto ou incorreto + motivo em ~30 palavras]\n"
        "Letra D: [correto ou incorreto + motivo em ~30 palavras]\n"
        "Letra E: [correto ou incorreto + motivo em ~30 palavras, se houver]\n\n"
